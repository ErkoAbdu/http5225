...
<header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
  ...
  <ul class="nav nav-pills justify-content-center">
    ...
    <li class="nav-item">
      <a class="nav-link active" href="it.php">Italian Riders</a>
    </li>
    <li class="nav-item">
  ...
  <?php
    $connect = mysqli_connect('sql311.infinityfree.com', 'if0_35758274', 'x96gqbkkqqrl', 'if0_35758274_http5225');    $query = 'SELECT riders_table.fname, riders_table.lname, riders_table.team, riders_table.nationality, manufacturer_table.manufacturer_name, riders_table.imageURL
    FROM riders_table 
