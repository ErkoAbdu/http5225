...
<header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
  ...
  <?php
    ...
    $query = 'SELECT riders_table.fname, riders_table.lname, riders_table.team, riders_table.nationality, manufacturer_table.manufacturer_name, riders_table.imageURL
    FROM riders_table 
